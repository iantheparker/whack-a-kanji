    ...
    return (
      <div className="main-container">
        <div className="game" style={{ WebkitTransform: this.state.shake }}>
          ...
          <div style={{ margin: 20 }}>
            <p>
              This is an experimental kanji learning game where some of the
              characters you see are real...and some are fakes, generated by AI.{" "}
              <b>Earn points by only whacking the fakes.</b> <br /> <br />
              Special thanks to{" "}
              <a href="http://blog.otoro.net/2015/12/28/recurrent-net-dreams-up-fake-chinese-characters-in-vector-format-with-tensorflow/">
                David Ha{" "}
              </a>{" "}
              for his kanji-dreaming AI. Check out the source code{" "}
